var app = (function (leaflet) {
	...
	var Sidebar = /*@__PURE__*/(function (EventTarget) {
	  function Sidebar(container, ref) {
	        if ( ref === void 0 ) ref = {};
	  ...
	  if ( EventTarget ) Sidebar.__proto__ = EventTarget;
	  Sidebar.prototype = Object.create( EventTarget && EventTarget.prototype );
	  ...
	  var prototypeAccessors = { current: { configurable: true } };
	    ...
	    Sidebar.prototype.enabled = function enabled (id) {
	        var ref = id && this._data[id] ? this._data[id] : { enabled: false };
	    ...
	    prototypeAccessors.current.set = function (current) {
	    ...
	    Sidebar.prototype.addTab = function addTab (ref) {
	        var id = ref.id;
	        var icon = ref.icon;
	        var opened = ref.opened;
	        var closed = ref.closed;
	        ...
	        icon.split(/\s+/g).forEach(function (x) { return ic.classList.add(x); });
	    ...
	    Sidebar.prototype._toggle = function _toggle (current) {
	        if (this.enabled(current)) {
	            this.current = this.current === current ? null : current;
	        }
	    };
	    Sidebar.prototype.getPane = function getPane (id) {
