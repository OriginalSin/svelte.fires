		...
		createMap(it) {
			...
			var picker = new Pikaday({
				...
				onSelect: function(date) {
					...
					// var beg = date.getTime() / 1000,
						// interval = [beg, beg + 60*60*24];
					// console.log('sssssss', interval, new Date(1000 * interval[0]), new Date(1000 * interval[1]))
				},
